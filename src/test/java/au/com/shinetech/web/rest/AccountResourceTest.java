...
import au.com.shinetech.repository.AuthorityRepository;
import au.com.shinetech.repository.UserRepository;
import au.com.shinetech.security.AuthoritiesConstants;
...
public class AccountResourceTest {
    ...
    public void testRegisterDuplicateLogin() throws Exception {
        ...
        UserDTO dup = new UserDTO(1L,
                u.getLogin(), u.getPassword(), u.getLogin(), u.getLastName(),
    ...
    public void testRegisterDuplicateEmail() throws Exception {
        ...
        UserDTO dup = new UserDTO(1L,
                "johnjr", u.getPassword(), u.getLogin(), u.getLastName(),
